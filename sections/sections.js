Vvveb.Sections.add("blogge/about", {
    name: "About",
    image: Vvveb.themeBaseUrl + "/screenshots/blogge/about-thumb.jpeg",
    html: `<section class="about">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="about-me">
          <img src="images/about/actior.png" alt="image">
          ...
          <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore
            ...
            <br>
            <br>Lorem ipsum dolor sit amet, consetetur
...
});Vvveb.Sections.add("blogge/blog", {
    name: "Blog",
    image: Vvveb.themeBaseUrl + "/screenshots/blogge/blog-thumb.jpeg",
    ...
    <div class="row">
      <div class="col-lg-8">
        ...
        <article class="blog-post">
          ...
          <div class="blog-post-content">
            ...
            <div class="blog-post-meta">
              <ul>
                <li>By <a href="about.html">Mary Astor</a>
                </li>
                <li>
            ...
            <a href="single-blog.html" class="blog-post-action">read more <i class="fa fa-angle-right"></i>
            </a>
          </div>
        </article>
        <article class="blog-post">
          <div class="blog-post-thumb">
            <a href="single-blog.html">
              <img src="images/blog/blog-thum-2.png" alt="blog-thum" />
            </a>
          </div>
          <div class="blog-post-content">
            <div class="blog-post-tag">
        ...
        <article class="blog-post">
          <div class="blog-post-thumb">
            <a href="single-blog.html">
              <img src="images/blog/blog-thum-3.png" alt="blog-thum" />
            </a>
          </div>
          <div class="blog-post-content">
            <div class="blog-post-tag">
        ...
        <article class="blog-post">
          <div class="blog-post-thumb">
            <a href="single-blog.html">
              <img src="images/blog/blog-thum-4.png" alt="blog-thum" />
            </a>
          </div>
          <div class="blog-post-content">
            <div class="blog-post-tag">
        ...
        <article class="blog-post">
          <div class="blog-post-thumb">
            <a href="single-blog.html">
              <img src="images/blog/blog-thum-5.png" alt="blog-thum" />
            </a>
          </div>
          <div class="blog-post-content">
            <div class="blog-post-tag">
        ...
        <article class="blog-post">
          <div class="blog-post-thumb">
            <a href="single-blog.html">
              <img src="images/blog/blog-thum-6.png" alt="blog-thum" />
            </a>
          </div>
          <div class="blog-post-content">
            <div class="blog-post-tag">
        ...
        <article class="blog-post">
          <div class="blog-post-thumb">
            <a href="single-blog.html">
              <img src="images/blog/blog-thum-7.png" alt="blog-thum" />
            </a>
          </div>
          <div class="blog-post-content">
            <div class="blog-post-tag">
        ...
        <div class="blog-post-widget">
          ...
          <div class="latest-widget">
            <div class="latest-widget-thum">
              <a href="single-blog.html">
                <img src="images/blog/blog-thum-8.png" alt="blog-thum" />
              </a>
              <div class="icon">
                <a href="single-blog.html">
          ...
          <div class="latest-widget">
            <div class="latest-widget-thum">
              <a href="single-blog.html">
                <img src="images/blog/blog-thum-9.png" alt="blog-thum" />
              </a>
              <div class="icon">
                <a href="single-blog.html">
                  <img src="images/blog/icon.svg" alt="icon" />
          ...
          <div class="latest-widget">
            <div class="latest-widget-thum">
              <a href="single-blog.html">
                <img src="images/blog/blog-thum-10.png" alt="blog-thum" />
              </a>
              <div class="icon">
                <a href="single-blog.html">
                  <img src="images/blog/icon.svg" alt="icon" />
          ...
          <div class="latest-widget">
            <div class="latest-widget-thum">
              <a href="single-blog.html">
                <img src="images/blog/blog-thum-11.png" alt="blog-thum" />
              </a>
              <div class="icon">
                <a href="single-blog.html">
                  <img src="images/blog/icon.svg" alt="icon" />
...
});Vvveb.Sections.add("blogge/contact", {
    name: "Contact",
    image: Vvveb.themeBaseUrl + "/screenshots/blogge/contact-thumb.jpeg",
        ...
        <div class="contact-information">
          ...
          <ul>
            ...
            <li>
              ...
              <a href="tel:+33-257634 534">Phone: +33-257634 534</a>
            </li>
          </ul>
      ...
      <div class="col-lg-6">
        <div class="contact-form">
          ...
          <form class="row" action="https://fabform.io/f/9APkcbe" method="post">
            ...
            <div class="col-md-12">
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="8" placeholder="Message here…"></textarea>
            </div>
            <div class="col-md-12">
...
});Vvveb.Sections.add("blogge/feature-post", {
    name: "Feature post",
    image: Vvveb.themeBaseUrl + "/screenshots/blogge/feature-post-thumb.jpeg",
    html: `<section class="featured">
  <div class="container">
    <div class="row">
      <div class="col-12">
...
});Vvveb.Sections.add("blogge/footer", {
    name: "Footer",
    image: Vvveb.themeBaseUrl + "/screenshots/blogge/footer-thumb.jpeg",
...
});Vvveb.Sections.add("blogge/instagram", {
    name: "Instagram",
    image: Vvveb.themeBaseUrl + "/screenshots/blogge/instagram-thumb.jpeg",
...
});Vvveb.Sections.add("blogge/navigation", {
    name: "Navigation",
    image: Vvveb.themeBaseUrl + "/screenshots/blogge/navigation-thumb.jpeg",
    html: `<!-- Navbar Start -->
...
<!-- Navbar End -->`
});Vvveb.Sections.add("blogge/single-blog", {
    name: "Single blog",
    image: Vvveb.themeBaseUrl + "/screenshots/blogge/single-blog-thumb.jpeg",
    html: `<section class="blog-single">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-10 order-1 order-lg-2">
        <article class="single-blog">
          ...
          <div class="single-blog-banner">
            <div class="banner">
              <img src="images/blog/single-blog.png" alt="banner">
            </div>
            <div class="banner">
              <img src="images/blog/single-blog-2.png" alt="banner">
            </div>
          </div>
        ...
        <div class="blog-single-presentation">
          <ul>
            ...
            <li>
              <a href="#" class="tag">Next</a>
              <a href="#" class="title">Every Next Level of Your Life
                Will Demand a Different</a>
              <i class="fa fa-clock-o"></i>
              October 19, 2020 - 2 min
            </li>
          </ul>
	...
	Vvveb.SectionsGroup["Blogge"] = ["blogge/about","blogge/blog","blogge/contact","blogge/feature-post","blogge/footer","blogge/instagram","blogge/navigation","blogge/single-blog"];
